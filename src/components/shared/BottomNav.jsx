...
const BottomNav = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-[#262626] p-2 h-16 flex justify-around">
      <button
        onClick={() => navigate("/")}
        className={`flex item-center justify-center pt-3 w-[200px] rounded-[20px] ${
      ...
      >
        <MdOutlineReorder className="inline mr-2 mt-0.5" size={20} />{" "}
        <p>Orders</p>
      </button>
      <button
      ...
      >
        <MdOutlineTableBar className="inline mr-2 mt-0.5" size={20} />{" "}
        <p>Tables</p>
      </button>
      <button
        className={`flex item-center justify-center pt-3 w-[200px] rounded-[20px] ${
